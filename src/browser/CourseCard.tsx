...
export function CourseCard({ course, onOpen }: CourseCardProps) {
  ...
  return (
    <button
      ...
      className="group flex flex-col gap-3 rounded-lg border border-border bg-card p-5 text-left transition-colors hover:border-muted-foreground/30 hover:bg-muted/30 focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] outline-none"
    >
